...
description: Creates new skills for the Antigravity agent environment following strict structural and formatting standards. Use when the user wants to create a new skill or defines a new reusable workflow.
---
